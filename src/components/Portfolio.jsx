      ...
      <div className={classes["portfolio"]}>
        <div className={classes["left"]}>
          <h1 className={classes["text"]}>
            ...
            prezentuję moje doświadczenie w tworzeniu relacji z wydarzeń, filmów
            korporacyjnych, spotów z wydarzeń czy dokumentacji inwestycji.
            Dzięki współpracy z różnymi firmami, szczególnie przy tworzeniu
            filmów ślubnych, zgromadziłem portfolio montaży filmowych, liczące
